...
namespace Momentum.Droid.Renderers
{
    public class CameraPageRenderer : PageRenderer, TextureView.ISurfaceTextureListener
    {
        ...
        void PrepareAndStartCamera()
        {
            ...
            //IList<Camera.Size> sizes1 = p.SupportedPictureSizes;
            //IList<Camera.Size> sizes2 = p.SupportedPreviewSizes;
        ...
        private async void TakePhotoButtonTapped(object sender, EventArgs e)
        {
            ...
            //var navigationPage = new NavigationPage(new PreviewPage(imageBytes))
            //{
            ...
            await NavigationService.Instance.ShowMomentPreviewAsync(imageBytes);
        }
    }
}
